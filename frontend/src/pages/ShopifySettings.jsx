...
const ShopifySettings = () => {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:3002/api/settings/shopify')
            .then(res => res.json())
            .then(data => {
    ...
    const handleSave = async () => {
        ...
        try {
            const res = await fetch('http://localhost:3002/api/settings/shopify', {
                method: 'POST',
            ...
            <div className="card" style={{ marginTop: '20px' }}>
                ...
                <button
                    ...
                    onClick={() => {
                        ...
                        fetch('http://localhost:3002/api/shopify/products')
                            .then(res => {
