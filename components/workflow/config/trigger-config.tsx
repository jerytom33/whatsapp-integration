...
import { Clock, Copy, MessageSquare, Play, Webhook } from "lucide-react";
...
export function TriggerConfig({
  ...
  return (
    <>
      <div className="space-y-2">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="WhatsApp Webhook">
              <div className="flex items-center gap-2">
      ...
      {config?.triggerType === "WhatsApp Webhook" && (
        <div className="rounded-md border border-blue-200 bg-blue-50 p-3 text-blue-900 dark:border-blue-800 dark:bg-blue-900/20 dark:text-blue-100">
          <p className="text-sm">
            This workflow will automatically trigger when a new message is
            received from the WhatsApp integration. The message payload will be
            available in the trigger data.
          </p>
        </div>
      )}
    </>
